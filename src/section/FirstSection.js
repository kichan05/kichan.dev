...
export function FirstSection() {
  ...
  return <section className="first-section">
    ...
    <div className="content">
      ...
      <div className="link">
        <a onclick="window.open('https://www.github.com/kichan05')">
        ...
        <a onclick="window.open('https://www.instagram.com/ckstmznf')">
        ...
        <a onclick="window.open('https://toss.me/바키찬희찬')" title="후원하기">
